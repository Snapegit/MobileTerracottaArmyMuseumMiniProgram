	...
	<div>
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					<el-col :span="24">
						<el-form-item label="臧品名称" prop="zangpinmingcheng">
							<el-input class="list_inp" v-model="form.zangpinmingcheng" placeholder="臧品名称"
								 type="text" 								:readonly="!isAdd||disabledForm.zangpinmingcheng?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="时代" prop="shidai">
							<el-input class="list_inp" v-model="form.shidai" placeholder="时代"
								 type="text" 								:readonly="!isAdd||disabledForm.shidai?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="尺寸" prop="chicun">
							<el-input class="list_inp" v-model="form.chicun" placeholder="尺寸"
								 type="text" 								:readonly="!isAdd||disabledForm.chicun?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="地质" prop="dizhi">
							<el-input class="list_inp" v-model="form.dizhi" placeholder="地质"
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			// getInfo()
			for(let x in row){
				if(x=='zangpinmingcheng'){
					form.value.zangpinmingcheng = row[x];
					disabledForm.value.zangpinmingcheng = true;
					continue;
				}
				if(x=='shidai'){
					form.value.shidai = row[x];
					disabledForm.value.shidai = true;
					continue;
				}
				if(x=='chicun'){
