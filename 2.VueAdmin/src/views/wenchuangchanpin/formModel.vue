		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="产品类型" prop="chanpinleixing">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.chanpinleixing?true:false"
								v-model="form.chanpinleixing" 
								placeholder="请选择产品类型"
								>
								<el-option v-for="(item,index) in chanpinleixingLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
					...
					<el-col :span="24">
						<el-form-item label="设计元素" prop="shejiyuansu">
							<el-input class="list_inp" v-model="form.shejiyuansu" placeholder="设计元素"
								 type="text" 								:readonly="!isAdd||disabledForm.shejiyuansu?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="主题" prop="zhuti">
							<el-input class="list_inp" v-model="form.zhuti" placeholder="主题"
								 type="text" 								:readonly="!isAdd||disabledForm.zhuti?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="材质" prop="caizhi">
							<el-input class="list_inp" v-model="form.caizhi" placeholder="材质"
								 type="text" 								:readonly="!isAdd||disabledForm.caizhi?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='chanpinleixing'){
					form.value.chanpinleixing = row[x];
					disabledForm.value.chanpinleixing = true;
					continue;
				}
				if(x=='shejiyuansu'){
					form.value.shejiyuansu = row[x];
					disabledForm.value.shejiyuansu = true;
					continue;
				}
				if(x=='zhuti'){
					form.value.zhuti = row[x];
					disabledForm.value.zhuti = true;
					continue;
				}
				if(x=='caizhi'){
